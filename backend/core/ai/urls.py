...
from .support_views import conversations_list_create, conversation_detail, tutorial_videos, help_search, chat_unified
...
urlpatterns = [
    ...
    path("unified/", chat_unified, name="chat-unified"),
]