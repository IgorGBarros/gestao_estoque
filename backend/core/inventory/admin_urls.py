...
from .admin_views import (
    ...
    admin_templates_listar,
    admin_contatos_renderizar_modelo,
    admin_contatos_historico,
    admin_pagamentos_loja,
    admin_marcas_disponiveis,
    admin_produtos_catalogo,
    admin_sql_console,
    admin_produto_criar,
    admin_produto_obter,
    admin_produto_atualizar,
    admin_produto_deletar,
    admin_produtos_aguardando,
    admin_produto_revisar,
    admin_barcode_candidate_approve,
    admin_barcode_candidate_reject,
    admin_barcode_candidate_set_image,
...
urlpatterns = [
    ...
    path('templates/', admin_templates_listar, name='admin_templates_listar'),
    path('contatos/renderizar-modelo/', admin_contatos_renderizar_modelo, name='admin_contatos_renderizar_modelo'),
    path('contatos/historico/', admin_contatos_historico, name='admin_contatos_historico'),
    path('pagamentos-loja/', admin_pagamentos_loja, name='admin_pagamentos_loja'),
    path('marcas-disponiveis/', admin_marcas_disponiveis, name='admin_marcas_disponiveis'),
    path('produtos-catalogo/', admin_produtos_catalogo, name='admin_produtos_catalogo'),
    path('sql-console/', admin_sql_console, name='admin_sql_console'),
    path('produtos-catalogo/criar/', admin_produto_criar, name='admin_produto_criar'),
    path('produtos-catalogo/<int:produto_id>/detalhe/', admin_produto_obter, name='admin_produto_obter'),
    path('produtos-catalogo/<int:produto_id>/', admin_produto_atualizar, name='admin_produto_atualizar'),
    path('produtos-catalogo/<int:produto_id>/deletar/', admin_produto_deletar, name='admin_produto_deletar'),
    path('produtos-aguardando/', admin_produtos_aguardando, name='admin_produtos_aguardando'),
    path('produtos-aguardando/<int:produto_id>/revisar/', admin_produto_revisar, name='admin_produto_revisar'),
    ...
    path('barcode-candidates/<int:candidate_id>/imagem/', admin_barcode_candidate_set_image, name='admin_barcode_candidate_set_image'),
