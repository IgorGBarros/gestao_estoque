// pages/Storefront.tsx — VERSÃO REFATORADA COM TEMA DINÂMICO
...
import { toast } from "../hooks/use-toast-original"; // ✅ Importar useToast original para evitar dependência circular
      ...
      <header className="relative overflow-hidden bg-gradient-to-br from-brand via-brand/90 to-brand-hover">
        ...
        <div className="relative mx-auto max-w-4xl px-6 pb-12 pt-8 text-center">
          <motion.div
            ...
            className="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-white/15 backdrop-blur-sm shadow-lg"
          >
            ...
            <div className="flex gap-2 overflow-x-auto pb-2 scrollbar-hide">
              ...
              {availableBrands.map((brand: string) => {
                ...
                return (
                  ...
                  >
                    {brand}
                    <span className="ml-2 text-xs opacity-70">({brandCount})</span>
                  </button>
                );
              })}
            </div>
            ...
            {filtered.map((item: StorefrontItem, i: number) => {
              ...
              return (
                <motion.div
                  ...
                  className="group relative flex flex-col overflow-hidden rounded-2xl border border-border bg-card transition-all duration-200 hover:shadow-lg hover:shadow-brand/5 hover:-translate-y-0.5"
                >
                  {/* Brand Badge */}
                  ...
                  {stockDisplay.isUrgent && quantity > 0 && (
                    <div className="absolute left-2 top-8 z-10 flex items-center gap-1 px-2 py-1 bg-destructive text-white text-[9px] font-bold rounded">
                  ...
                  {qtyInBag > 0 && (
                    <div className="absolute right-2 top-2 z-10 flex h-6 w-6 items-center justify-center rounded-full bg-brand text-[11px] font-bold text-white shadow-md">
                      {qtyInBag}
                    </div>
                  )}
                  ...
                  <div className="flex flex-1 flex-col p-3 border-t border-border/50">
                    ...
                    <div className="mt-3 flex gap-2">
                      <Button
                        size="sm"
                        variant="outline"
                        className="rounded-xl h-9 flex-1 bg-secondary/50 border-transparent hover:border-brand/30 hover:bg-brand/10 hover:text-brand transition-all text-xs font-semibold"
        ...
        {bagCount > 0 && (
          ...
          >
            ...
            >
              ...
              {bagTotal > 0 && (
                <span className="text-base font-black">{formatMoney(bagTotal)}</span>
              )}
            </Button>
          </motion.div>
        )}
          ...
          {bag.length === 0 ? (
            ...
            <div className="flex flex-col gap-5 mt-2">
                  ...
                  <button
                    ...
                    className={`flex flex-col items-center justify-center gap-2 rounded-xl border-2 p-3 transition-all ${
                      paymentMethod === "pix"
                        ...
                        : "border-border bg-card text-muted-foreground hover:border-brand/30 hover:bg-secondary/50"
                    }`}
                  >
              ...
              <div className="space-y-2 pt-2">
                ...
                <Button
                  variant="ghost"
                  className="w-full text-xs text-muted-foreground hover:bg-destructive/10 hover:text-destructive transition-colors"
                  onClick={clearBag}
                >
                  Esvaziar sacola
                </Button>
